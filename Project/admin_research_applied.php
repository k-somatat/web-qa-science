...
<div id="page-wrapper" class="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#admin_research_applied" data-toggle="tab">ผลงานวิจัยที่นำไปใช้ประโยชน์</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="admin_research_applied">
...
//                    }
        ...
        function confirm_delete(rid) {
            bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
                if (result) {
                    ...
                    window.location = 'sqlfunction.php?method=admin_delete_research&rid=' + rid + '&cur=' + 3;
                } else {
    ...
    <script>
        function export_xls() {
            window.location = 'src/function/export_research_admin_applied_xls.php';
        }
    </script>
