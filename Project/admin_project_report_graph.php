...
<!-- content -->
      <div id="page-wrapper" class="page-wrapper">
          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <ul class="nav nav-pills">
                      <li><a href="admin_project_report.php">ข้อมูลโครงการทั้งหมด</a></li>
                      <li class="active"><a href="#admin_project_report_graph" data-toggle="tab">ข้อมูลโครงการรูปแบบกราฟ</a></li>
                  </ul>
              </div>
          </div>
          ...
          <div class="tab-pane active" id="admin_project_report_graph">
            <div class="col-lg-12">
