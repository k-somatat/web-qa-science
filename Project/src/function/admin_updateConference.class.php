...
class admin_updateConference
{
    public function __construct()
    {
        $cid =$_GET['id'];

        if ($_POST['task'] && $_POST['major'] && $_POST['date'] && $_POST['location'] && $_POST['userAuthor'] != "") {
                            ...
                            if($month == $end_month){
                                if($day <= $end_day){
                                    ...
                                    bootbox.alert('กรุณากรอกช่วงเวลาให้ถูกต้อง',function(){
                                         window.location=\"" . site_url . "admin_conference_form.php?cid=$cid\"
                                    })
                                    </script>";
                                    exit;
                                }
            ...
            $conference->conference_tech_name = $user['user_first_name'][0]." ".$user['user_last_name'][0];
            ...
            // user not permission this case
                ...
                $conference->user_id = $_POST['userAuthor'];
