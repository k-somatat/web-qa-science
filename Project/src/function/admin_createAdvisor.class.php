...
class admin_createAdvisor
{
    ...
    public function __construct(){
            ...
            switch ($_POST['sdd']) {
                case 0 :
                    $atyid = 1;
                    if ($_POST['name'] && $_POST['first_name'] && $_POST['last_name'] && $_POST['year'] && $_POST['userAuthor'] != "" ) {
                            ...
                            if($_POST['first_name2'] && $_POST['last_name2'] != ""){
                                ...
                                echo "<script type='text/javascript'>
                                    bootbox.alert('กรุณากรอกข้อมูลกรอกข้อมูลให้ครบถ้วน',function(){
                                        window.location=\"" . site_url . "admin_advisor_form.php?atyid=$atyid\"
                                    })
                                    </script>";
                                exit;
                            }
                        ...
                        $advisor->user_id = $_POST['userAuthor'];
                    ...
                    echo "<script type='text/javascript'>
                        bootbox.alert('บันทึกข้อมูลเรียบร้อยแล้ว',function(){
                            window.location=\"" . site_url . "admin_advisor_project.php\"
                        })
                        </script>";
                    } else {
                ...
                case 1 :
                    $atyid = 2;
                     if ($_POST['name'] && $_POST['first_name'] && $_POST['last_name'] && $_POST['year'] && $_POST['location']  && $_POST['userAuthor'] != "") {
                        ...
                        echo "<script type='text/javascript'>
                            bootbox.alert('บันทึกข้อมูลเรียบร้อยแล้ว',function(){
                                window.location=\"" . site_url . "admin_advisor_cooperative_education.php\"
                            })
                            </script>";
                     } else {
                ...
                case 2 :
                    $atyid = 3;
                    if ($_POST['detail'] && $_POST['classYear'] && $_POST['amountPerson'] && $_POST['date'] && $_POST['userAuthor'] != "") {
                        ...
                        echo "<script type='text/javascript'>
                            bootbox.alert('บันทึกข้อมูลเรียบร้อยแล้ว',function(){
                                window.location=\"" . site_url . "admin_advisor_class.php\"
                            })
                            </script>";
                    } else {
