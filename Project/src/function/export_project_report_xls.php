 ...
 */
        ...
        $filename ="ข้อมูลโครงการทั้งหมด ".$current_date.".xls";
        ...
        for($index = 0; $index<count($_SESSION['projectReport']['project_id']); $index++){
            echo "<tr> <td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>". $_SESSION['projectReport']['project_pre'][$index]."</td>";
            echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>".$_SESSION['projectReport']['project_name'][$index]."</td>";

            switch($_SESSION['projectReport']['project_author_amount'][$index]){
                case 1 :
                    echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>".$_SESSION['projectReport']['project_author'][$index]."</td>";
                    break;
                case 2 :
                    echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>"
                        .$_SESSION['projectReport']['project_author'][$index].'<br>'
                     .$_SESSION['projectReport']['project_author2'][$index].'</td>' ;
                    break;
                case 3 :
                    echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>"
                        .$_SESSION['projectReport']['project_author'][$index].'<br>'
                        .$_SESSION['projectReport']['project_author2'][$index]. '<br>'
                         .$_SESSION['projectReport']['project_author3'][$index].  '</td>' ;
                    break;

            }

            $split_date = explode('-', $_SESSION['projectReport']['project_date'][$index]);
            $split_date_end = explode('-', $_SESSION['projectReport']['project_date_end'][$index]);
            $split_date[0] = $split_date[0]+543;
            $split_date_end[0] = $split_date_end[0]+543;

            if($_SESSION['projectReport']['project_date'][$index] != '0000-00-00') {
            $date = $split_date[2] . "-" . $split_date[1] . "-" . $split_date[0];
            }else{
                $date = '';
            }

            if($_SESSION['projectReport']['project_date_end'][$index] != '0000-00-00') {
            ...
            echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>".$_SESSION['projectReport']['project_process'][$index]."</td>";
            echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>".$_SESSION['projectReport']['project_budget'][$index]."</td>";
            echo "<td align=center style='font-size: 21px'><font face='Angsana New' color=#fff>".$_SESSION['projectReport']['project_final_budget'][$index]."</td></tr></center>";
            $count++;
        }
