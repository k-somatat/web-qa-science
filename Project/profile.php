...
<!--                                    <label class="control-label" for="inputSuccess2"><b style="color: #040404">--><?//echo $user_name?><!--</b></label>-->
                ...
                <div class="modal-footer">
                   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                           <a href="profile_edit.php" class="btn btn-primary form-control">แก้ไขข้อมูลส่วนตัว</a>
                   </div>
                   <br class="visible-xs visible-sm">
                   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                           <a href="change_password_form.php" class="btn btn-primary form-control">เปลี่ยนรหัสผ่าน</a>
                   </div>
                   <br class="visible-xs visible-sm">
