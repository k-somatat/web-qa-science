    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-<?= $page_icon; ?>"></i> ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติแต่ละภาค<
            </ol>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li><a href="president_tqf.php">ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
                <li class="active"><a href="#sub_president_tqf">ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติแต่ละภาค</a></li>
<!--                <li><a href="president_tqf_graph.php">ข้อมูล มคอ. รูปแบบกราฟ</a></li>-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="sub_president_tqf">
            <p class="col-md-12" style="text-align: center; margin-bottom: 30px; margin-top: 30px; font-size: large; ">
                รายละเอียดการอบรม/สัมมนา/ประชุมวิชาการ แต่ละภาควิชา </p>
...
<!--                    <input type="submit" value="ค้นหา" class="btn btn-danger " style="position: absolute; margin-left: 260px; width: 100px; height:35px; margin-top: 3px">-->
            ...
            <table class=" table fa-border table-bordered ">
                ...
                <th  style=" height: 50px;  text-align: center; width: 20%"> รายชื่อวิชา <i class="fa fa-sort"></i></th>
                <th  style=" height: 50px;  text-align: center; width: 20%"> ชื่ออาจารย์ <i class="fa fa-sort"></i></th>
                <th style=" text-align: center; width: 20%"> มคอ.3/4 <i class="fa fa-sort" ></i></th>
                <th style=" text-align: center; width: 20%"> มคอ.5/6 <i class="fa fa-sort" ></i></th>
                                    ...
                                    switch($majorId){
                                        ...
                                        case 1 :
                                            ...
                                            echo "<td>" . $major['major_name'][0] . "</td>" .
                                                ...
                                                "<td>" . $conference['conference_budget'][$index] . "</td></tr>" ;
...
//                                                "<td>" . "<a href='".site_url."sub_president_conference.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td></tr>" ;
                        ...
                        }else if($NoTQF[1] == $spiltYear[0]+543){
...
//                                                "<td>" . "<a href='".site_url."sub_president_conference.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td></tr>" ;
                        ...
                        }else if($NoTQF[2] == $spiltYear[0]+543){
