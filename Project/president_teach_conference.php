...
$page_icon = "list-alt";
$page_president_teach_conference_active = "active";
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li class="active"><a href="#conference">ข้อมูลสรุปผลการอบรม/สัมมนา/ประชุมวิชาการทั้งหมด</a></li>
                <li><a href="president_conference_form.php">เพิ่มข้อมูลสรุปผลการอบรม/สัมมนา/ประชุมวิชาการ</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="conference">
            ...
            <table class=" table-bordered ">
                ...
                <th style="width: 15%;"class="text-center">หน่วยงาน <i class="fa fa-sort"></i></th>
                <th style="width: 11%; text-align: center">วันที่เข้าร่วมงาน <i class="fa fa-sort"></i></th>
                <th style="width: 5%; text-align: center">สถานที่ <i class="fa fa-sort"></i></th>
                <th  style="width: 10%; text-align: center">ชื่อบุคลากร <i class="fa fa-sort"></i></th>
                <th  style="width: 10%; text-align: center">ชื่อการประชุม <i class="fa fa-sort"></i></th>
                <th style="width: 5%; class="text-center">ค่าใช้จ่าย (บาท) <i class="fa fa-sort"></i></th>
                ...
                $conferencesUserId = $conferenceDao->findbyUserId($_SESSION['USER']['user_id'][0]);
                $_SESSION['conference'] = $conferencesUserId;
                ...
                for ($index = 0; $index < $len; $index++) {
                    if ($conference['user_id'][$index] == $_SESSION["USER"]["user_id"][0]) {
                        ...
                        echo "<tr style='text-align: center'>
                            ...
                            $splitName = explode(' ',$conference['conference_tech_name'][$index]);



                            echo "<td>" . $splitName[0].$splitName[1]." ".$splitName[2] . "</td>" ;
                            echo "<td>" . $conference['conference_topic'][$index] . "</td>" ;
                        ...
                        echo
                            "<td>" .
                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='president_conference_form.php?cid=" . $conference['conference_id'][$index] . "'>
    ...
    function confirm_delete(cid) {
        bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
            if (result) {
                ...
                window.location = 'sqlfunction.php?method=president_delete_conference&cid=' + cid;
            } else {
...
?>
    ...
    <script>
        function export_xls() {
            window.location = 'src/function/export_conference_xls.php';
        }
    </script>
