    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#research_applied" data-toggle="tab">ผลงานวิจัยที่นำไปใช้ประโยชน์</a></li>
                <li><a href="president_teach_research_form.php">เพิ่มข้อมูลงานวิจัย</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="research_applied">
            ...
            <table class="table-bordered">
                ...
                $_SESSION['researchApplied'] = $researchUserId;
...
//                            '<td>' ."<table boder='1' style='width: 100%;'><tr><td>"."เริ่ม  ". $research['research_date'][$index] ."</td></tr><tr><td>". "ถึง  "
//                            . $research['research_date_end'][$index] ."</td></tr></table>". '</td>';
//                            '<td>' . "เริ่มต้น  " . $research['research_date'][$index] . " สิ้นสุด "
//                            . $research['research_date_end'][$index] . '</td>';
                        ...
                        echo
                            "<td>" .
                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='president_teach_research_form.php?rid=" . $research['research_id'][$index] . "'>
        ...
        function confirm_delete(rid) {
            bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
                if (result) {
                    ...
                    window.location = 'sqlfunction.php?method=president_delete_research&rid=' + rid + '&cur=' + 3;
                } else {
    ...
    <script>
        function export_xls() {
            window.location = 'src/function/export_research_applied_xls.php';
        }
    </script>
