...
$page_icon = "list-alt";
$page_home_active = "";
$page_admin_time_schedule_active = "active";
// Page Setup END
?>
		...
		<div class="col-lg-12">
			<div class="row">
				<form name="datetimepicker" class="col-lg-12"
					action="admin_time_schedule.php" method="post">
					<div class="pull-left">
					...
					<div class="pull-right">
						<a href="admin_time_schedule_add.php" class="btn btn-primary">เพิ่มกิจกรรม</a>
					</div>
				</form>
			</div>
		</div>
