    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#president_research_graph_academic" data-toggle="tab">การเสนอผลงานวิจัย/วิชาการ</a></li>
...
<!--                <li><a href="president_research_graph_budget.php">กราฟแสดงงบประมาณงานวิจัยแต่ละปีการศึกษา</a></li>-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active form-horizontal" id="president_research_graph_academic">
            <p class="col-md-12" style="text-align: center; margin-bottom: 30px; margin-top: 30px; font-size: large; ">
                การเสนอผลงานวิจัย/วิชาการ </p>
                ...
                <div class="form-group">
                    <div class="form-control col-sm-12" style="background-color: ; border-left: hidden; border-right: hidden; border-top: hidden; height: 50px">
                        <form method="post" action="<?=site_url.'sqlfunction.php?method=president_search_research&NoData=2'?>">
...
//                    $authorNotResearch2 = $MathQuery2 + $PhysicsQuery2 + $ChemistryQuery2 + $FoodQuery2 + $ComQuery2;
            ...
            ?>
                    ...
                    <div class="col-sm-5" style="background-color: #fde5ef; height: 100px; margin-top: 20px; margin-left: 40px; ">
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 50px">กราฟแสดงจำนวนอาจารย์ที่เสนอผลงานวิจัย/วิชาการ </label><br>
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 25px">จำนวนผู้ทำวิจัย</label>
                        <label for="lb_subject" style="margin-left: 40px; ">  <?=$authorResearch?> คน</label><br>
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 20px">จำนวนผู้ไม่ทำวิจัย</label>
                    ...
                    <div class="col-sm-5" style="background-color: #cee7ff; height: 100px; margin-top: 20px; margin-left: 60px">
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 100px">กราฟแสดงจำนวนผลงานวิจัยที่ตีพิมพ์ </label><br>
