...
<div id="page-wrapper" class="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#president_research_funded" data-toggle="tab">งานวิจัยที่ได้รับทุนสนับสนุน</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="president_research_funded">
