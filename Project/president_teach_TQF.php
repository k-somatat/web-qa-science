...
$page_icon = "list-alt";
$page_president_teach_TQF_active = "active";
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li><a href="president_TQF_form.php">เพิ่มข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
            ...
            <table class=" table-bordered ">
                ...
                for ($index = 0; $index < $len; $index++) {
                    if ($tqf['user_id'][$index] == $_SESSION["USER"]["user_id"][0]) {
                        ...
                        echo
                            "<td>" .
                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='president_tqf_form.php?tid=" . $tqf['tqf_id'][$index] . "'>
    ...
    function confirm_delete(tid) {
        bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
            if (result) {
                ...
                window.location = 'sqlfunction.php?method=president_delete_tqf&tid=' + tid;
            } else {
