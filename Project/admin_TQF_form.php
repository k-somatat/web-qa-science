...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            <li><a href="admin_TQF.php">ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
            <li class="active"><a class="active" href="#admin_TQF_form" data-toggle="tab">เพิ่มข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a>
            </li>
        </ul>
    </div>
</div>
...
if (!empty($_GET['tid'])) {
    ...
    $user_id = $tqfs['user_id'][0];

} else {
    $query_method = "admin_create_tqf";
    $tqf_id = "";
    $tqf_subject = "";
    $tqf_semester = "";
    $tqf_subject_update = "";
