          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <ul class="nav nav-pills">
                      ...
                      <li><a href="president_teach_advisor_cooperative_education.php" >อาจารย์ที่ปรึกษาสหกิจศึกษา</a></li>
    ...
    function confirm_delete(aid){
        bootbox.confirm("ยืนยันการลบข้อมูล !", function(result) {
            if(result){
                ...
                window.location='sqlfunction.php?method=president_delete_advisor&aid='+aid+'&cur='+1;
            } else {
