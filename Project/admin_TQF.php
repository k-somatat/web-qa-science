    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li class="active"><a href="#admin_TQF">ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
                <li><a href="admin_TQF_form.php">เพิ่มข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
...
//                    if ($tqf['user_id'][$index] == $_SESSION["USER"]["user_id"][0]) {
                    ...
                    echo '<td>'. $date . '</td>';
                        ...
                        echo
                            "<td>" .
                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='admin_tqf_form.php?tid=" . $tqf['tqf_id'][$index] . "'>
    ...
    function confirm_delete(tid) {
        bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
            if (result) {
                ...
                window.location = 'sqlfunction.php?method=admin_delete_tqf&tid=' + tid;
            } else {
