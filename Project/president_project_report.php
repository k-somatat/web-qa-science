...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            ...
            <li><a href="president_project_report_graph.php">ข้อมูลโครงการรูปแบบกราฟ</a></li>
        </ul>
    </div>
</div>
<!-- /.row -->
...
//                    $final_budget = $project['project_final_budget'][$index] != null  ? $project['project_final_budget'][$index]  : "<font color=blue ><b> - </b></font>";
            ...
            echo "<td>" . $project['project_name'][$index] . '</td>' ;
                $spilt_user = explode(' ',$users['user_first_name'][0]);
            echo '<td>' . $spilt_user[0].$spilt_user[1]." ".$users['user_last_name'][0] . '</td>' ;
