...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            <li><a href="president_teach_TQF.php">ข้อมูลกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาแห่งชาติ</a></li>
...
if (!empty($_GET['tid'])) {
    $query_method = "president_update_tqf";
    ...
    $query_method = "president_create_tqf";
    $tqf_id = "";
    $tqf_subject = "";
    $tqf_semester = "";
    $tqf_subject_update = "";
