...
<!-- Header Include Here -->
<?php require_once("admin/commons/page-header1.0.php"); ?>
<!-- End Header Include -->
<!-- content -->
      <div id="page-wrapper">
        <div class="row">
          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <ul class="nav nav-pills">
                      <li class="active"><a href="#admin_index">ข่าว ประชาสัมพันธ์ คณะวิทยาศาสตร์</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="admin_index">
                    ...
                    <div class="panel-body">
                        <div class="list-group">
                            ...
                            for($index = $length-1; $index >= 0; $index--){
                                ...
                                echo '<a href="admin_news_detail.php?id='.$news['news_id'][$index].'" class="list-group-item">';
