      ...
      <div id="page-wrapper" class="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li>หน้าแรก</li>
              <li class="active"><i class="fa fa-<?=$page_icon; ?>"> แบบฟอร์มหลักสูตร</i> </li>
            </ol>
          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <ul class="nav nav-pills">
                      ...
                      <li class="active"><a href="#admin_course" data-toggle="tab">แบบฟอร์มหลักสูตร</a></li>
          ...
          <div class="tab-content">
              ...
              <div class="tab-pane active" id="admin_course">
        ...
        function confirm_delete(cid) {
            bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
                if (result) {
                    ...
                    window.location = 'sqlfunction.php?method=admin_delete_course&cid=' + cid+"&cur="+2;
                } else {
