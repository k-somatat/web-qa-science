...
<div id="page-wrapper" class="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li class="active"><a href="#admin_research_academic" data-toggle="tab">การเสนอผลงานวิจัย/วิชาการ</a></li>
                ...
                <li><a href="admin_research_form.php">เพิ่มข้อมูลงานวิจัย</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="admin_research_academic">
            ...
            <table class="table-bordered">
                ...
                $researchUserId = $researchDAO->findAll();
                $_SESSION['researchAcademic'] = $researchUserId;
                ...
                for ($index = 0; $index < $len; $index++) {
                    ...
                    echo "<td>" . $spiltName[0].$spiltName[1]." ".$spiltName[2] . '</td>' .
                        ...
                        echo
                            "<td>" .
                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='admin_research_form.php?rid=" . $research['research_id'][$index] . "'>
...
//                    }
        ...
        function confirm_delete(rid) {
            bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
                if (result) {
                    ...
                    window.location = 'sqlfunction.php?method=admin_delete_research&rid=' + rid + '&cur=' + 1;
                } else {
    ...
    <script>
        function export_xls() {
            window.location = 'src/function/export_research_admin_academic_xls.php';
        }
    </script>
