...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="active"><a href="#admin_project" data-toggle="tab">ข้อมูลโครงการทั้งหมด</a></li>
...
<!-- Tab panes -->
    ...
    <div class="tab-pane active" id="admin_project">
        ...
        <table class="table-bordered">
            ...
            <thead class="table-modify" style="text-align: center">
                ...
                <th  style="width: 5 %; text-align: center">เอกสารอ้างอิงบันทึกข้อความขออนุมัติ <i class="fa fa-sort"></i></th>
                <th  style="width: 5 %; text-align: center">เอกสารอ้างอิงบันทึกข้อความสรุปค่าใช้จ่าย <i class="fa fa-sort"></i></th>
                <th  style="width: 5 %; text-align: center">เอกสารอ้างอิงสรุปผลโครงการ <i class="fa fa-sort"></i></th>
                <th  style="width: 5 %; text-align: center">รูปกิจกรรม <i class="fa fa-sort"></i></th>
...
<!--            </tr>-->
            ...
            $_SESSION['projectXls'] = $projectUserId;

            for($index = 0; $index < count($_SESSION['projectXls']['project_id']); $index++){
                switch($_SESSION['projectXls']['project_author_amount'][$index]){
                    case 1 :
                        $user = $userDao->findbyUserId($_SESSION['projectXls']['project_author'][$index]);
                        $splitName = explode(' ',$user['user_first_name'][0]);
                        $_SESSION['projectXls']['author'][$index] = $splitName[0].$splitName[1] ." ".$user['user_last_name'][0];
                        break;
                    case 2 :
                        $user = $userDao->findbyUserId($_SESSION['projectXls']['project_author'][$index]);
                        $user2 = $userDao->findbyUserId($_SESSION['projectXls']['project_author2'][$index]);

                        $splitName = explode(' ',$user['user_first_name'][0]);
                        $splitName2 = explode(' ',$user2['user_first_name'][0]);

                        $_SESSION['projectXls']['author'][$index] = $splitName[0].$splitName[1] ." ".$user['user_last_name'][0];
                        $_SESSION['projectXls']['author2'][$index] = $splitName2[0].$splitName2[1] ." ".$user2['user_last_name'][0];
                        break;
                    case 3 :
                        $user = $userDao->findbyUserId($_SESSION['projectXls']['project_author'][$index]);
                        $user2 = $userDao->findbyUserId($_SESSION['projectXls']['project_author2'][$index]);
                        $user3 = $userDao->findbyUserId($_SESSION['projectXls']['project_author3'][$index]);
                        ...
                        $_SESSION['projectXls']['author'][$index] = $splitName[0].$splitName[1] ." ".$user['user_last_name'][0];
                        $_SESSION['projectXls']['author2'][$index] = $splitName2[0].$splitName2[1] ." ".$user2['user_last_name'][0];
                        $_SESSION['projectXls']['author3'][$index] = $splitName3[0].$splitName3[1] ." ".$user3['user_last_name'][0];
                        break;
...
//                    $final_budget = $project['project_final_budget'][$index] != null  ? $project['project_final_budget'][$index]  : "<font color=blue ><b> - </b></font>";
                ...
                switch($project['project_author_amount'][$index]){
                    case 1 :
                        ...
                        $splitName = explode(' ',$user['user_first_name'][0]);
                        echo "<td>" . $splitName[0].$splitName[1] ."<br>".$user['user_last_name'][0].  '</td>' ;
                        break;
                    case 2 :
                        $user = $userDao->findbyUserId($project['project_author'][$index]);
                        ...
                        echo '<td>' ."<table boder='1' style='width: 100%;'><tr><td>". $splitName[0].$splitName[1] ."<br>".$user['user_last_name'][0] ."</td></tr>";
                        echo "<tr><td>".$splitName2[0].$splitName2[1] ."<br>".$user2['user_last_name'][0]."</td></tr></table>". '</td>';
                        break;
                    case 3 :
                        $user = $userDao->findbyUserId($project['project_author'][$index]);
                        $user2 = $userDao->findbyUserId($project['project_author2'][$index]);
                        ...
                        echo "<tr><td>".$splitName[0].$splitName[1] ."<br>".$user['user_last_name'][0] ."</td></tr>";
                        echo "<tr><td>".$splitName2[0].$splitName2[1] ."<br>".$user2['user_last_name'][0]."</td></tr>";
                        echo "<tr><td>".$splitName3[0].$splitName3[1] ."<br>".$user3['user_last_name'][0]."</td></tr></table>".'</td>';
                        break;
                    default :
                        echo "<td>" . ''.  '</td>' ;
                ...
                if($project['project_date_end'][$index] != '0000-00-00'){
                    ...
                    echo
                    "<td>" .
                    "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='admin_project_form.php?pid=" . $project['project_id'][$index] . "'>
    ...
    function confirm_delete(pid) {
        bootbox.confirm("ยืนยันการลบข้อมูล !", function (result) {
            if (result) {
                ...
                window.location = 'sqlfunction.php?method=delete_project&pid=' + pid+'&cur='+2;
            } else {
