...
$page_icon = "list-alt";
$page_president_time_schedule_active = "active";
		...
		<div class="col-lg-12">
			<div class="row">
				<form name="datetimepicker" class="col-lg-12"
					action="president_time_schedule.php" method="post">
					<div class="pull-left">
					...
					<div class="pull-right">
						<a href="president_time_schedule_add.php" class="btn btn-primary">เพิ่มกิจกรรม</a>
					</div>
				</form>
			</div>
		</div>
