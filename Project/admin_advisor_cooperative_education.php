...
<!--                      <li><a href="student_class.php">ข้อมูลนักศึกษา</a></li>-->
                      ...
                      <li class="active"><a href="#admin_advisor_cooperative_education" data-toggle="tab">อาจารย์ที่ปรึกษาสหกิจศึกษา</a></li>
          ...
          <!-- Tab panes -->
            ...
            <div class="tab-pane" id="admin_advisor_cooperative_education">
            ...
            function confirm_delete(aid){
                bootbox.confirm("ยืนยันการลบข้อมูล !", function(result) {
                    if(result){
                        ...
                        window.location='sqlfunction.php?method=admin_delete_advisor&aid='+aid+'&cur='+2;
                    } else {
