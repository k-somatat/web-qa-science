...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            <li><a href="president_teach_conference.php">ข้อมูลสรุปผลการอบรม/สัมมนา/ประชุมวิชาการทั้งหมด</a></li>
            <li class="active"><a class="active" href="#president_conference_form" data-toggle="tab">เพิ่มข้อมูลสรุปผลการอบรม/สัมมนา/ประชุมวิชาการ</a>
            </li>
        </ul>
    </div>
</div>
...
if (!empty($_GET['cid'])) {
    $query_method = "president_update_conference";
    ...
    $query_method = "president_create_conference";
    $conference_id = "";
    $conference_name = "";
