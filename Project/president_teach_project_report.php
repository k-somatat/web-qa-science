...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-pills">
            <li class="active"><a href="#project_report" data-toggle="tab">ข้อมูลโครงการทั้งหมด</a></li>
            <li><a href="president_teach_project_report_graph.php">กราฟแสดงข้อมูลโครงการ</a></li>
        </ul>
    </div>
</div>
<!-- /.row -->
...
<!-- Tab panes -->
    ...
    <div class="tab-pane active" id="project_report">
        ...
        <table class="table-bordered">
            ...
            <thead class="table-modify" style="text-align: center">
                ...
                <th  style="width: 10 %; text-align: center">งบประมาณได้รับการอนุมัติ <i class="fa fa-sort"></i></th>
                <th  style="width: 10 %; text-align: center">งบประมาณใช้จริง <i class="fa fa-sort"></i></th>
