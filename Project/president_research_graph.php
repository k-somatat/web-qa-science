    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>งานวิจัย</li>
                <li class="active"><i class="fa fa-<?= $page_icon; ?>"></i> กราฟแสดงผลงานวิจัยแต่ละปีการศึกษา</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#president_research_graph" data-toggle="tab">กราฟแสดงผลงานวิจัยแต่ละปีการศึกษา</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active form-horizontal" id="president_research_graph">
            <p class="col-md-12" style="text-align: center; margin-bottom: 30px; margin-top: 30px; font-size: large; ">
                เปรียบเทียบจำนวนผลงานวิจัยแต่ละปีการศึกษา </p>
...
//                        }
            ...
            ?>
                    ...
                    <div class="col-sm-5" style="background-color: #fde5ef; height: 100px; margin-top: 20px; margin-left: 40px; ">
                        ...
                        <label for="lb_subject" style="margin-left: 22px"> : <?=$authorResearch?> คน</label><br>
