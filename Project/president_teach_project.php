...
$page_name = "โครงการ";
$page_icon = "list-alt";
$page_president_teach_project_active = "active";
...
<!--            <li><a href="president_project_form.php">เพิ่มข้อมูลโครงการ</a></li>-->
        </ul>
    </div>
</div>
<!-- /.row -->
    ...
    <div class="tab-pane active" id="project">
        ...
        <table class="table-bordered">
            ...
            <thead class="table-modify" style="text-align: center">
                ...
                <th  style="width: 20%; text-align: center">ชื่อโครงการ <i class="fa fa-sort"></i></th>
                <th  style="width: 15%; text-align: center">ผู้รับผิดชอบ <i class="fa fa-sort"></i></th>
                <th  style="width: 10%; text-align: center">ระยะเวลาดำเนินการ <i class="fa fa-sort"></i></th>
...
<!--            </tr>-->
            ...
            for ($index = 0; $index < $len; $index++) {
                if ($project['project_author'][$index] ==  $_SESSION["USER"]["user_id"][0] || $project['project_author2'][$index] ==  $_SESSION["USER"]["user_id"][0] || $project['project_author3'][$index] ==  $_SESSION["USER"]["user_id"][0]) {
...
//                    $final_budget = $project['project_final_budget'][$index] != null  ? $project['project_final_budget'][$index]  : "<font color=blue ><b> - </b></font>";
                   ...
                   $split_final_budget = explode(".",$project['project_final_budget'][$index]);;
                    ...
                    echo
                        "<td>" .
                        "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='president_project_form.php?pid=" . $project['project_id'][$index] . "'>
