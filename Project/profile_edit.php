...
//    $email = explode('@',$user['username'][0]);

    $user_email = $user['username'][0];

    $user_fullName = $user['user_first_name'][0];
...
//    $user_tel = substr("$tel",0,2)."-".substr("$tel",2,4)."-".substr("$tel",6,4);
    ...
    $majors = new Major();
    $majors = $majorsDAO->findbyMajorId($user_major);

    $facultiesDAO = new FacultyDAO();
    $faculties = new Faculty();
    $faculties = $facultiesDAO->findbyFacultyId($majors['faculty_id'][0]);
...
<form class="form-horizontal" role="form" method="post"
      action="<?= site_url . "sqlfunction.php?method=update_profile" ?>" enctype="multipart/form-data">
    ...
    <div class="form-group" >
        ...
        <div class="col-sm-5 input-group">
            <input type="text" class="form-control" id="email" name="email"
                   value="<?= $user_email ?>" placeholder="อีเมล์" disabled >
        </div>
        <div class="col-sm-3">
            <label style="font-size: large; color: red">*</label>
        </div>
...
<!--                   value="วิทยาศาสตร์" placeholder="คณะที่สังกัด" disabled>-->
<!--        </div>-->
        <div class="col-sm-5">
    ...
    <div class="form-group">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 12px">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                ...
                <button type="reset" id="clear" class="btn btn-default btn-lg" onclick="back_page()">
                    ยกเลิก
                </button>
            </div>
        </div>
