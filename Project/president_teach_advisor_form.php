...
<div id="page-wrapper" class="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#advisor_form" data-toggle="tab">เพิ่มข้อมูล</a></li>
            </ul>
        </div>
    </div>
    <!-- /.row -->
    ...
    if (!empty($_GET['aid'])) {
        if($_GET['cancel'] == ""){
        $query_method = "president_update_advisor";
        $control_select = 1;
    ...
    //        set values textfield advisor author 2
        ...
        $query_method = "president_create_advisor";
        $advisor_id = "";
        $advisor_name = "";
    ...
    <div class="tab-pane" id="advisor_form">
        <p class="col-md-12"
