...
<!--                      <li><a href="student_class.php">ข้อมูลนักศึกษา</a></li>-->
                      ...
                      <li class="active"><a href="#president_advisor_project" data-toggle="tab">อาจารย์ที่ปรึกษาโครงงาน</a></li>
                      <li><a href="president_advisor_cooperative_education.php" >อาจารย์ที่ปรึกษาสหกิจศึกษา</a></li>
<!--                      <li><a href="advisor_form.php" >เพิ่มข้อมูล</a></li>-->
          ...
          <div class="tab-pane" id="president_advisor_project">
...
<!--                            <th class="wrapper-text-center" style="width: 7%">ลำดับที่</th>-->
<!--                            <th class="wrapper-text-center" style="width: 30%">ชื่อโครงการ</th>-->
<!--                            <th class="wrapper-text-center" style="width: 20%">ผู้จัดทำ</th>-->
<!--                            <th style="text-align: center; width: 10%">ปีการศึกษา</th>-->
<!--                            <th style="text-align: center; width: 10%">เอกสารอ้างอิง</th>-->
<!--                            <th>แก้ไขข้อมูล</th>-->
<!--                            <th>ลบข้อมูล</th>-->
<!---->
<!--                  </thead>-->
    ...
    function confirm_delete(aid){
        bootbox.confirm("ยืนยันการลบข้อมูล !", function(result) {
            if(result){
                ...
                window.location='sqlfunction.php?method=delete_advisor&aid='+aid+'&cur='+1;
            } else {
