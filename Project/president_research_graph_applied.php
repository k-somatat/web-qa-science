    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#president_research_graph_applied" data-toggle="tab">ผลงานวิจัยที่นำไปใช้ประโยชน์</a></li>
<!--                <li><a href="president_research_graph_budget.php">กราฟแสดงงบประมาณงานวิจัยแต่ละปีการศึกษา</a></li>-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active form-horizontal" id="president_research_graph_applied">
            <p class="col-md-12" style="text-align: center; margin-bottom: 30px; margin-top: 30px; font-size: large; ">
                ผลงานวิจัยที่นำไปใช้ประโยชน์ </p>
                ...
                <div class="form-group">
                    <div class="form-control col-sm-12" style="background-color: ; border-left: hidden; border-right: hidden; border-top: hidden; height: 50px">
                        <form method="post" action="<?=site_url.'sqlfunction.php?method=president_search_research&NoData=4'?>">
        ...
        <div class="form-group">
            ...
            <?
                ...
                for($index = 0; $index<count($research['research_id']); $index++){
                    if($research['research_type_id'][$index] == 3){
...
//                    $authorNotResearch2 = $MathQuery2 + $PhysicsQuery2 + $ChemistryQuery2 + $FoodQuery2 + $ComQuery2;
            ...
            ?>
                    ...
                    <div class="col-sm-5" style="background-color: #fde5ef; height: 100px; margin-top: 20px; margin-left: 40px; ">
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 35px">กราฟแสดงจำนวนอาจารย์ที่มีผลงานวิจัยที่นำใช้ประโยชน์ </label><br>
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 25px">จำนวนผู้มีผลงานวิจัย</label>
                        <label for="lb_subject" style="margin-left: 40px; ">  <?=$authorResearch?> คน</label><br>
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 20px">จำนวนผู้ไม่มีผลงานวิจัย</label>
                    ...
                    <div class="col-sm-5" style="background-color: #cee7ff; height: 100px; margin-top: 20px; margin-left: 60px">
                        <label for="lb_subject" style="margin-top: 5px; margin-left: 65px">กราฟแสดงจำนวนผลงานวิจัยที่นำไปใช้ประโยชน์ </label><br>
