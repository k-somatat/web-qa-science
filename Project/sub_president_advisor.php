    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-<?= $page_icon; ?>"></i> ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจแต่ละภาค</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li><a href="president_advisor.php">ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจ</a></li>
                <li class="active"><a href="#president_advisor" data-toggle="tab">ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจแต่ละภาค</a></li>
<!--                <li><a href="president_advisor_graph.php" >รูปแบบกราฟ</a></li>-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="president_advisor">
            <p class="col-md-12" style="text-align: center; margin-bottom: 30px; margin-top: 30px; font-size: large; ">
                ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจแต่ละภาค </p>
...
<!--                    <input type="submit" value="ค้นหา" class="btn btn-danger " style="position: absolute; margin-left: 260px; width: 100px; height:35px; margin-top: 3px">-->
            ...
            <table class=" table fa-border table-bordered ">
                ...
                <th  style=" height: 50px;  text-align: center; width: 20%"> ชื่ออาจารย์ <i class="fa fa-sort"></i></th>
                <th style=" text-align: center; width: 40%">ชื่อโครงการ <i class="fa fa-sort" ></i></th>
                <th style=" text-align: center; width: 20%">จำนวนนักศึกษา <i class="fa fa-sort"></i></th>
<!--                <th style=" text-align: center; width: 5%">ดูรายละเอียด <i class="fa fa-sort"></i></th>-->
                ...
                if(!empty($_GET['NoCo'])){
                    $NoAvisor = unserialize($_GET['NoCo']);
                }
                                        ...
                                        switch($majorId){
                                            ...
                                            case 1 :
                                                ...
                                                echo "<td>" . $major['major_name'][0] . "</td>" .
                                                    ...
                                                    "<td>" . $advisor['advisor_name'][$index] . "</td>" .
                                                    "<td>" . $advisor['advisor_amount'][$index] . "</td></tr>" ;
