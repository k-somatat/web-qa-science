    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-<?= $page_icon; ?>"></i> ข้อมูลการอบรม/สัมมนา/ประชุมวิชาการ แต่ละภาควิชา</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="#president_conference">ข้อมูลการอบรม/สัมมนา/ประชุมวิชาการ แต่ละภาควิชา</a></li>
...
<!--                    <input type="submit" value="ค้นหา" class="btn btn-danger " style="position: absolute; margin-left: 260px; width: 100px; height:35px; margin-top: 3px">-->
            ...
            <table class=" table fa-border table-bordered ">
                ...
                <th  style=" height: 50px;  text-align: center; width: 20%"> ชื่อผู้จัดทำ <i class="fa fa-sort"></i></th>
                <th style=" text-align: center; width: 40%">ชื่องาน <i class="fa fa-sort" ></i></th>
                <th style=" text-align: center; width: 20%">จำนวนค่าใช้จ่ายในการอบรม / บาท <i class="fa fa-sort"></i></th>
                                    ...
                                    switch($majorId){
                                        ...
                                        case 1 :
                                            ...
                                            echo "<td>" . $major['major_name'][0] . "</td>" .
                                                ...
                                                "<td>" . number_format($conference['conference_budget'][$index],2) . "</td></tr>" ;
