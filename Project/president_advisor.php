...
$page_icon="list-alt";
$page_president_advisor_active = "active";
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-<?= $page_icon; ?>"></i> ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจ</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                <li class="active"><a href="#president_advisor" data-toggle="tab">ข้อมูลภาระงานอาจารย์ที่ปรึกษาสหกิจ</a></li>
<!--                <li><a href="president_advisor_graph.php" >อาจารย์ที่ปรึกษาโครงงาน</a></li>-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="president_advisor">
            ...
            <div class="form-group">
                ...
                <form method="post" action="<?=site_url.'sqlfunction.php?method=president_search_advisor&NoData=1'?>">
                ...
                <div >
                    <select class="form-control" name="startYear" style="position: absolute; margin-left: 100px; width: 100px; height: 30px; margin-top: 5px">
                        ...
                        for($index = 0; $index<count($advisor['advisor_id']); $index++){

                            $int = intval($advisor['advisor_year'][$index]);

                            if(strlen($advisor['advisor_year'][$index]) <= 6){
                                if(strlen($advisor['advisor_year'][$index]) == 4){

                                    $yearQuery = $advisor['advisor_year'][$index];
...
<!--                    <input type="submit" value="ค้นหา" class="btn btn-danger " style="position: absolute; margin-left: 260px; width: 100px; height:35px; margin-top: 3px">-->
            ...
            <table class=" table fa-border table-bordered ">
                ...
                <th style=" text-align: center">จำนวนนักศึกษา / คน <i class="fa fa-sort" ></i></th>
                ...
                if(!empty($_GET['NoCo'])){
                    $NoAdvisor = unserialize($_GET['NoCo']);
                }
                    ...
                    if(!empty($NoAdvisor)){
                        ...
                        if(strlen($advisor['advisor_year'][$index]) <= 6){
                            if(strlen($advisor['advisor_year'][$index]) == 4){
                                ...
                                $spiltYear = $advisor['advisor_year'][$index];
                        ...
                        if($NoAdvisor[0] == $spiltYear){

                            $userRole = $userRoleDAO->findbyUserId($advisor['user_id'][$index]);

                            if($userRole['role_id'][0] != 1 && $userRole['role_id'][0] != 2 && $userRole['role_id'][0] != 9 && $userRole['role_id'][0] != 10){

                                $user = $userDAO->findbyUserId($advisor['user_id'][$index]);

                                if($advisor['advisor_type_id'][$index] == 2){

                                    switch($user['major_id'][0]){
                                        case 1 :
                                            $Math = $Math + 1;
                                            $MathName = $MathName + 1;
                                            $MathAmount = $MathAmount+$advisor['advisor_amount'][$index];
                                            break;
                                        case 2 :
                                            $Physics = $Physics + 1;
                                            $PhysicsName = $PhysicsName + 1;
                                            $PhysicsAmount = $PhysicsAmount+$advisor['advisor_amount'][$index];
                                            break;
                                        case 3 :
                                            $Chemistry = $Chemistry + 1;
                                            $ChemistryName = $ChemistryName + 1;
                                            $ChemistryAmount = $ChemistryAmount+$advisor['advisor_amount'][$index];
                                            break;
                                        case 4 :
                                            $Food = $Food + 1;
                                            $FoodName = $FoodName + 1;
                                            $FoodAmount = $FoodAmount+$advisor['advisor_amount'][$index];
                                            break;
                                        case 5 :
                                            $Com = $Com + 1;
                                            $ComName = $ComName + 1;
                                            $ComAmount = $ComAmount+$advisor['advisor_amount'][$index];
                                            break;
                                    }
                                }
                            }

                        }else if($NoAdvisor[1] == $spiltYear){
                ...
                for($index = 0; $index<count($major['major_id']); $index++){
                    ...
                    $majorId = $major['major_id'][$index];
                        switch($major['major_id'][$index]){
                            case 1 :
                                echo "<td>" . $MathAmount . "</td>" .
                                    "<td>" . $MathName . "</td>" .
                                    "<td>" . "<a href='".site_url."sub_president_advisor.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td>" ;

                                break;
                            case 2 :
                                echo "<td>" . $PhysicsName . "</td>" .
                                    "<td>" . $PhysicsAmount . "</td>" .
                                "<td>" . "<a href='".site_url."sub_president_advisor.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td>" ;

                                break;
                            case 3 :
                                echo "<td>" . $ChemistryName . "</td>" .
                                    "<td>" . $ChemistryAmount . "</td>" .
                                    "<td>" . "<a href='".site_url."sub_president_advisor.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td>" ;
                            ...
                            case 5 :
                                echo "<td>" . $ComName . "</td>" .
                                    "<td>" . $ComAmount . "</td>" .
                                    "<td>" . "<a href='".site_url."sub_president_advisor.php?mid=$majorId$urlPortion'><img src='".site_url."images/watch_image.png' width='30'></a>" . "</td></tr>" ;
                ...
                $totalAmount= $MathAmount+$PhysicsAmount+$ChemistryAmount+$FoodAmount+$ComAmount;
                ?>
