...
<!--                      <li><a href="student_class.php">ข้อมูลนักศึกษา</a></li>-->
                      <li class="active"><a href="#president_advisor_class" data-toggle="tab">อาจารย์ที่ปรึกษาชั้นปี</a></li>
              ...
              function confirm_delete(aid){
                  bootbox.confirm("ยืนยันการลบข้อมูล !", function(result) {
                      if(result){
                          ...
                          window.location='sqlfunction.php?method=delete_advisor&aid='+aid+'&cur='+3;
                      } else {
