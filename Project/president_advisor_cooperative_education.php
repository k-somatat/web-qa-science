...
<!--                      <li><a href="student_class.php">ข้อมูลนักศึกษา</a></li>-->
                      <li><a href="president_advisor_class.php" >อาจารย์ที่ปรึกษาชั้นปี</a></li>
                      <li><a href="president_advisor_project.php">อาจารย์ที่ปรึกษาโครงงาน</a></li>
                      <li class="active"><a href="#president_advisor_cooperative_education" data-toggle="tab">อาจารย์ที่ปรึกษาสหกิจศึกษา</a></li>
<!--                      <li><a href="advisor_form.php">เพิ่มข้อมูล</a></li>-->
          ...
          <!-- Tab panes -->
            ...
            <div class="tab-pane" id="president_advisor_cooperative_education">
                ...
                <table class="table-bordered">
                    <thead class="table-modify" style="text-align: center">
                        ...
                        <th style="width: 18%; text-align: center;">ผู้จัดทำ <i class="fa fa-sort"></i></th>
                        <th style="text-align: center; width: 10%">ปีการศึกษา <i class="fa fa-sort"></i></th>
                        <th style="text-align: center; width: 15%">สถานประกอบการ <i class="fa fa-sort"></i></th>
                        <th  style="width: 15%; text-align: center">ชื่ออาจารย์ที่ปรึกษา <i class="fa fa-sort"></i></th>
...
//                        echo
//                            "<td>".
//                            "<button class='btn btn-large btn-info btn-primary' onclick=window.location.href='advisor_form.php?aid=".$advisor['advisor_id'][$index]."'>
            ...
            function confirm_delete(aid){
                bootbox.confirm("ยืนยันการลบข้อมูล !", function(result) {
                    if(result){
                        ...
                        window.location='sqlfunction.php?method=delete_advisor&aid='+aid+'&cur='+2;
                    } else {
